...
RSpec.describe "My Requests", type: :feature, js: true do
  ...
  let(:department) { create(:department, :with_head, name: "ITIMS") }
  let(:staff_profile) do
 create(:staff_profile, :with_supervisor, department:, user:, given_name: "Pat", surname: "Doe")
  end
  ...
  xit "I can filter reports" do
    ...
    direct_report = create(:staff_profile, supervisor: staff_profile, department: staff_profile.department,
                                           given_name: "Sally", surname: "Smith")
    create(:absence_request, creator: staff_profile.supervisor, start_date: Date.parse("2019-10-12"),
    ...
    create(:absence_request, creator: direct_report, action: "approve",
    ...
    create(:absence_request, creator: staff_profile, absence_type: "sick", action: "approve", start_date: Date.parse("2019-10-15"),
    ...
    create(:travel_request, :with_note_and_estimate, creator: staff_profile, action: "approve",
