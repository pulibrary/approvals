...
RSpec.describe Ldap, type: :model do
  describe "#find_by_netid" do
    ...
    it "returns json ldap data about the user when connected to the actual ldap (you must be on campus or VPN for this to work)",
       :no_ci do
    ...
    context "I stub out the connection" do
      ...
      it "returns json about the user" do
        ...
        expect(described_class.find_by_netid("cac9",
                                             ldap_connection: connection)).to eq(address: "Firestone Library$Library Information Technology",
                                                                                 department: "Library - Office of the Deputy University Librarian",
                                                                                 netid: "cac9")
      end
    end
