...
describe("HoursCalculator.vue", () => {
  ...
  it("updates the total hours requested caption/hint", () => {
    ...
    expect(wrapper.vm.helperCaption).toBe('16 hours = 2 days (1 holiday and weekend dates excluded.)')
    wrapper.vm.updateCaption('24')
    expect(wrapper.vm.helperCaption).toBe('24 hours = 3 days (1 holiday and weekend dates excluded.)')
  })
