...
class RequestReport
  attr_reader :start_date, :end_date, :file_path
  ...
  def csv
    headers = %w[start_date end_date event_name trip_id surname given_name department
                 estimated_cost status event_format]
