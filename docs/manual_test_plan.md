...
|5|Press on the delegator's name|The person's name should be removed from the form|
...
|8|Press the Status dropdown. | The dropdown should show several options including pending|
|9|Select the Pending option. | The page should only include pending requests|
|10|Click on one of the delegator's 'Pending' requests.|You should be able to see the request with active 'Edit', 'Cancel the Request' and 'Comment' buttons|
|11|Press 'Comment' button|The form should display a notes area.|
|12|Type your comment and press 'Comment' button.|The form should display your comment as the delegator's comment.|
|13|Press 'Edit' button|The form should display in edit mode.|
|14|Select a different 'Date range'|The new date range should reflect in the input box|
|15|Type a new value in 'Total hours requested'|The new value should reflect in the input box|
